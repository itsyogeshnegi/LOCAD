  ...
  return (
    <>
      <Navbar bg="light" variant="light" expand="lg" className="px-4 xl:px-14">
        ...
        <Navbar.Collapse id="navbar-nav justify-content-center">
          <Nav className="ml-auto">
            ...
            <NavDropdown
              ...
              style={{ color: "black" }}>
              <NavDropdown.Item href="/Mobile-Ad-Platform">
                <p className="font-bold">LOCAD MOBILE ADS</p>
              </NavDropdown.Item>
              ...
              <NavDropdown.Item href="/Screeno">
                <p className="font-bold">SCREENO</p>
              </NavDropdown.Item>
              <NavDropdown.Item href="/LocadGalaxy">
            ...
            <NavDropdown
              ...
              id="basic-nav-dropdown"
              style={{ color: "black" }}>
              <NavDropdown.Item href="https://www.dmgv.in/" target="_blank">
        ...
        <Navbar.Collapse style={{ display: "none" }}>
          <Nav.Link
            title="Instagram"
