  ...
  return (
    <>
      ...
      <div className="planoFeatures">
        ...
        <div className="plano_box">
          <ol start={1}>
            ...
            <li>
              1.Targeting and Segmentation: Select sites based on demographic,
              geographic, and psychographic criteria.
            </li>
            <li>
              2.Budget Allocation: Manage your budget efficiently across
              different locations.
            </li>
            <li>
              3.Performance Forecasting: Use predictive analytics to estimate
              the impact and reach of your campaigns.
            </li>
          </ol>
        </div>
        <div className="plano_box">
          <ol start={1}>
            <p className="text-xl font-semibold">Sales and Booking</p>
            <li>
              1.Automated Sales Processes: Streamline workflows for booking and
              sales, reducing manual effort.
            </li>
            <li>
              2.Client Portal: Provide clients with a dedicated portal to view
              available sites, book spaces, and track campaign progress.
            </li>
            <li>
        ...
        <div className="plano_box">
          <ol start={1}>
            <p className="text-xl font-semibold">Reporting and Analytics</p>
            <li>
              1.Detailed Reports: Generate customizable reports on inventory
              status, campaign performance, and financials.
            </li>
            <li>
              2.Data Integration: Integrate with other data sources and
              platforms for comprehensive analysis.
            </li>
            <li>
              3.Dashboards: Monitor real-time data and gain insights through
      ...
      <div className="flex w-full flex-col px-2 justify-center items-center my-3">
        ...
        {/* <p className="mx-7 text-justify">{` `}</p> */}
      </div>
      <Footer />
    </>
  );
